...
cols_to_plot = ["p1hr","p2hr", "temperatur",\
 "humidity", "pressure", "windspeed", "winddirect"]
i = 1
# plot each column
...
X_train = df_train.loc[:, ["p1hr", "temperatur", "humidity",\
 "pressure", "windspeed", "winddirect","Month", "Date", "gmt"]].values.copy()
...
def generate_train_samples(x = X_train, y = y_train, batch_size = 24,\
...
def plot_test(final_preds, test_y):
    ...
    ax.set_title("Test Predictions vs. Actual For November")
